...
# How to repeat the evaluations

The folder `example_models/xxx` holds all feature models used in the evaluation for the respective papers. All models are provided as uvl-files and can be used to reproduce the family-based analysis. 

For repeating an instance-based analysis the configuration files have to be generated using [FeatureIDE](https://featureide.github.io/).
