...
public class JSSPGenerator extends SPGenerator {
    ...
    public void generateProblem(int jobCount, int taskCount,
        ...
        createOptionalTasks(optionalCount, machines, jobs, optionalTasks);
        createAlternativeTasks(altCount, altGroupCount, machines, jobs, optionalTasks);
        ...
        Path filepath = path.resolve(name + "-jssp.uvl");
     ...
     */
    private void createOptionalTasks(int optionalCount, List<Machine> machines, List<List<Task>> jobs,
        ...
        for (int i = 0; i < optionalCount; i++) {
            List<Task> job = new ArrayList<>();
            Task task = createRandomTask("po" + taskID, true, machines, false);
            taskID++;
     ...
     */
    private void createAlternativeTasks(int altCount, int altGroupCount, List<Machine> machines,
     ...
     */
    private void createDurationConstraints(List<Task[]> optionalTasks, List<Task> mandatoryTasksWithVarDuration,
        ...
        if (!optionalTasks.isEmpty()) {
            ...
            for (int i = 0; i < durationConstraints; i++) {
                ...
                for (int j = 0; j < maxDurationRequires; j++) {
                    ...
                    int taskGroupIndex = optionalIndices.get(this.random.nextInt(optionalIndices.size()));
                    ...
                    int taskIndex = this.random.nextInt(taskGroup.length);
