...
public class JSSPGenerator extends SPGenerator {
    ...
    private void createStandardJobs(int taskCount, int jobCount, int machineCount, int durationOutlierCount,
        ...
        for (int i = 0; i < jobCount; i++) {
            ...
            for (int j = 0; j < tasksInJob; j++) {
                ...
                taskID++;
                task.setMachine(machines.get(this.random.nextInt(machineCount)));
     ...
     */
    private void createOptionalTasks(int optionalCount, int machineCount, List<Machine> machines, List<List<Task>> jobs,
        ...
        for (int i = 0; i < optionalCount; i++) {
            ...
            int varDurationChance = this.random.nextInt(2);

            // 0 = Variable, 1 = static
            if (varDurationChance == 0) {
                // Between 1 and 5
                int dur1 = this.random.nextInt(5) + 1;
                int dur2 = this.random.nextInt(5) + 1;
                int[] duration = {dur1, dur2};
                task.setDurations(duration);
            } else {
                // Not variable
                int dur = this.random.nextInt(5) + 1;
     ...
     */
    private void createAlternativeTasks(int altCount, int altGroupCount, int machineCount, List<Machine> machines,
        ...
        if (altCount > 0 && altGroupCount > 0) {
            ...
            for (int i = 0; i < altGroupCount; i++) {
                ...
                for (int j = 0; j < tasksInGroup; j++) {
                    ...
                    int variableDurationChance = this.random.nextInt(2);
                    // 0 = Variable, 1 = static
